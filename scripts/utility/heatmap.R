...
dd.row  <- as.dendrogram(hclust(dist(testMat)))
...
x <- heatmap.2(testMat, Colv=dd.col.rev , Rowv=dd.row ,col=colorpanel(40, "red", "black", "green"),scale="none",key=TRUE,keysize=0.7,symkey=FALSE,density.info="none",trace="none",cexRow=0.5,cexCol=1.1 , dendrogram="column")
